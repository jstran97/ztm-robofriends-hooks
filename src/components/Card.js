...
const Card = ( { name, email, id } ) => {
    ...
    return (
        ...
        // w-100 w-50-m w-third-l - Cards take full width on mobile, 50% on medium screens, 25% on large screens
        ...
        <div className='tc bg-light-green dib br3 pa3 ma2 grow shadow-5 w-100 w-third-m w-fourth-l f4 f3-m f2-l w-auto-ns maxWidth'>
